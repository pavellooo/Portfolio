...
The repository for this project may found on my GitHub profile, and is automatically synced and deployed to the web service.
...
It is also worth noting that everything so far has been done completely for free using a student GitHub account, and we do not plan to spend any of our budget money for the rest of the semester. The goal is to implement security and report on it to fellow students and developers, and the solutions should not be locked behind payment methods of any kind if possible. This way, anybody can recreate our steps very easily.
...
We will write a second paper and publish our findings. There is an Undergraduate Research Symposium in April 2026 in which we will have the opportunity to show our results as well. We also plan to produce supplementary resources (powerpoints) for the Computer Science Faculty here at BGSU to use in their classes, specifically on cybersecurity and passkeys.
